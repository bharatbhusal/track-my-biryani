...
import { createExpense, listExpenses } from '@/repositories/expense.repository';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const filters = expenseFiltersSchema.parse(Object.fromEntries(request.nextUrl.searchParams.entries()));
