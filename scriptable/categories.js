...
const { renderSmall } = importModule("components/categories/small");
const { renderMedium } = importModule("components/categories/medium");
const { renderLarge } = importModule("components/categories/large");
const { renderCircular } = importModule("components/categories/circular");
const { renderRectangular } = importModule("components/categories/rectangular");
