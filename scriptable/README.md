...
| ------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `BASE_URL`          | `http://localhost:3400/api`                                                       | API base URL the widgets call                                           | For production change the value to `https://trackmybiryani.bharatbhusal.com/api` (also noted in a comment above the key). |
| `WEBSITE_URL`       | `http://localhost:3400`                                                           | Web app base URL, used to open the app from a widget                    | Production: `https://trackmybiryani.bharatbhusal.com`.                                                                    |
