...
check(date.formatDay("2026-08-05T12:00:00Z") === "05 Aug", `formatDay = ${date.formatDay("2026-08-05T12:00:00Z")}`)
check(date.relativeDay(new Date().toISOString()) === "Today", "relativeDay(today) = Today")
check(date.formatClock(new Date(2026, 7, 5, 22, 30)) === "10:30 PM", `formatClock = ${date.formatClock(new Date(2026, 7, 5, 22, 30))}`)
check(date.formatClock24(new Date(2026, 7, 5, 22, 4)) === "22:04", `formatClock24 = ${date.formatClock24(new Date(2026, 7, 5, 22, 4))}`)
check(date.formatClock24(new Date(2026, 7, 5, 9, 5)) === "09:05", `formatClock24 pad = ${date.formatClock24(new Date(2026, 7, 5, 9, 5))}`)
